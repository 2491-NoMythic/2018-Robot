 ...
 *
 */
public class PreciseDrive extends CommandBase {
	...
	protected void execute() {
		turnSpeed = 0.5 * oi.getAxisDeadzonedSquared(ControllerMap.driveController, ControllerMap.driveTurnAxis, 0.05) / Variables.driveRestriction;
		...
		drivetrain.drivePercentOutput(0.3 * (currentLeftSpeed + turnSpeed), 0.3 * (currentRightSpeed - turnSpeed));
	}
